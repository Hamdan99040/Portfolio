...
export async function POST(request: Request) {
  try {
    ...
    if (userMessage.includes('hello') || userMessage.includes('hi ') || userMessage.includes('hey') || userMessage.includes('greetings')) {
      ...
      reply = "Hamdan's professional journey spans development and QA environments:\n\n- **Full Stack Developer Intern** at *Devzox* (2025 – 2026):\n  He worked on frontend development with React.js and backend APIs with Node.js/Express, handled database management with MongoDB, and contributed to production features.\n- **SQA Engineer** (2025 – Present):\n  He is responsible for end-to-end manual testing, regression testing cycles, writing comprehensive test cases, API testing with Postman, and structured bug reporting.\n\nHis diverse background makes him highly adaptable to both startup and enterprise engineering cycles!";
      ...
      reply = "You can easily get in touch with Hamdan! ✉️\n\n- **Email:** `hamdanyaseen99040@gmail.com` (or use the **Contact Form** at the bottom of the home page)\n- **LinkedIn:** [Muhammad Hamdan Yaseen on LinkedIn](https://www.linkedin.com/in/hamdan-yaseen-27b7b2258/)\n- **GitHub:** [Hamdan's GitHub Profile](https://github.com/Hamdan99040)\n\nAlternatively, you can drop him a message directly through the contact form, and he will receive it instantly on his secure admin panel. Shall I explain how to access the secure vault next?";
